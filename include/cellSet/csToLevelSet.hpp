...
enum struct csToLevelsetEnum : unsigned {
  ANALYTICAL = 0,
  LOOKUP = 1,
  SIMPLE = 2,
};
...
public:
  ...
  csToLevelSet(LSType &passedLevelSet) : levelSet(&passedLevelSet) {}

  csToLevelSet(LSType &passedLevelSet, CSType &passedCellSet)
