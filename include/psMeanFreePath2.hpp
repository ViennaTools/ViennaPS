...
template <class NumericType, int D> class psMeanFreePath2 {
public:
  psMeanFreePath2() : traceDevice(rtcNewDevice("hugepages=1")) {
...
#pragma omp for schedule(dynamic)
      for (long long idx = 0; idx < numRays; ++idx) {
        ...
        while (true) {
          ...
          const auto rayHitPoint =
              rayTriple<NumericType>{ray.org_x + ray.dir_x * ray.tfar,
