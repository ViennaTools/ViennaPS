...
//     atomicAdd(&params.resultBuffer[getIdx(ION_PARTICLE_IDX, 0, &params)],
//     Y_sp);

//     // ion enhanced etching yield Y_ie ionEnhancedFlux
//     atomicAdd(&params.resultBuffer[getIdx(ION_PARTICLE_IDX, 1, &params)],
//     Y_ie);

//     // ion enhanced O sputtering yield Y_O ionPolymerFlux
//     atomicAdd(&params.resultBuffer[getIdx(ION_PARTICLE_IDX, 2, &params)],
//     Y_p);
...
//           Eref_max *
//           (1.f - (1.f - A_cont) *
//                      pow((M_PI_2f - incAngle) / (M_PI_2f - inflectAngle),
//                      n_r));
//     }
//     else
//     {
...
//     energy float tempEnergy = Eref_peak * prd->energy; float NewEnergy;
...
//       randomDir[1] = a1 * cosTheta_p_a0_tmp_sinphi + prd->dir[2] *
//       tmp_cosphi; randomDir[2] = prd->dir[2] * cosTheta_p_a0_tmp_sinphi - a1
//       * tmp_cosphi;
...
//     atomicAdd(&params.resultBuffer[getIdx(ETCHANT_PARTICLE_IDX, 0, &params)],
//     prd->rayWeight);
...
//   {
//     const unsigned int primID = optixGetPrimitiveIndex();
//     atomicAdd(&params.resultBuffer[getIdx(POLY_PARTICLE_IDX, 0, &params)],
//     prd->rayWeight);
...
//     atomicAdd(&params.resultBuffer[getIdx(ETCHANTPOLY_PARTICLE_IDX, 0,
//     &params)], prd->rayWeight); const float Seff = gamma_pe * max(1.f -
//     phi_pe, 0.f); prd->rayWeight -= prd->rayWeight * Seff;
//     diffuseReflection(prd);
//   }
// }
