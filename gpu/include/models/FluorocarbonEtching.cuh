...
#include <models/psFluorocarbonEtchingParameters.hpp>
...
fluorocarbonIonCollision(const void *sbtData, viennaray::gpu::PerRayData *prd) {
  viennaps::gpu::FluorocarbonEtchingParametersStaticF *params =
      reinterpret_cast<viennaps::gpu::FluorocarbonEtchingParametersStaticF *>(
