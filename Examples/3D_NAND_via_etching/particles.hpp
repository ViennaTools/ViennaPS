...
public:
    ...
    void initNew(rayRNG &RNG) override final
    {
        ...
        do
        {
            ...
            E = std::cos(twoPI * rand1) * std::sqrt(-2. * std::log(rand2)) * deltaEnergy + meanEnergy;
        } while (E < 0);
    }
...
public:
                          ...
                          rayRNG &Rng) override final
    {
        ...
        // {
        //   // std::cout << "ERROR: primitive ID is out of range of coverages!" << std::endl;
        //   id = globalData.getVectorData(0).size() - 1;
        // }
...
template <typename NumericType, int D>
class EtchantPoly : public rayParticle<EtchantPoly<NumericType, D>, NumericType>
{
public:
    void surfaceCollision(NumericType rayWeight,
                          const rayTriple<NumericType> &rayDir,
