...
class BoxDistribution(ProcessModel):
    @overload
    def __init__(self, halfAxes, gridDelta: float, mask: viennals2d.viennals2d.Domain) -> None: ...
    @overload
...
class Domain:
    ...
    @overload
    def __init__(self, gridDelta: float, xExtent: float, boundary: viennals2d.viennals2d.BoundaryConditionEnum = ...) -> None: ...
    def applyBooleanOperation(self, arg0: viennals2d.viennals2d.Domain, arg1: viennals2d.viennals2d.BooleanOperationEnum) -> None: ...
    def clear(self) -> None: ...
    ...
    def saveHullMesh(self, filename: str, wrappingLayerEpsilon: float = ...) -> None: ...
    ...
    def saveVolumeMesh(self, filename: str, wrappingLayerEpsilon: float = ...) -> None: ...
    def setMaterialMap(self, arg0) -> None: ...
    def setup(self, gridDelta: float, xExtent: float, yExtent: float = ..., boundary: viennals2d.viennals2d.BoundaryConditionEnum = ...) -> None: ...
...
class Domain3D:
    ...
    @overload
    def __init__(self, gridDelta: float, xExtent: float, yExtent: float, boundary: viennals2d.viennals2d.BoundaryConditionEnum = ...) -> None: ...
...
class GeometryFactory:
    ...
    def makeBoxStencil(self, arg0, arg1: float, arg2: float, arg3: float) -> viennals2d.viennals2d.Domain: ...
    def makeCylinderStencil(self, arg0, arg1: float, arg2: float, arg3: float) -> viennals2d.viennals2d.Domain: ...
    def makeMask(self, arg0: float, arg1: float) -> viennals2d.viennals2d.Domain: ...
    def makeSubstrate(self, arg0: float) -> viennals2d.viennals2d.Domain: ...
...
class SphereDistribution(ProcessModel):
    @overload
    def __init__(self, radius: float, gridDelta: float, mask: viennals2d.viennals2d.Domain) -> None: ...
    @overload
