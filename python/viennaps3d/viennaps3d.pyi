...
class Domain:
    ...
    def getBoundingBox(self) -> list[list[float], list[float]]: ...
    def getCellSet(self): ...
    def getGrid(self): ...
    ...
    def saveHullMesh(self, filename: str, wrapLayerEpsilon: float = ...) -> None: ...
...
class GDSGeometry:
    ...
    def layerToLevelSet(
        self, arg0: int, arg1: float, arg2: float, arg3: bool = ...
    ): ...
    def print(self) -> None: ...
