...
class BoxDistribution(ProcessModel):
    @typing.overload
    def __init__(self, halfAxes: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], gridDelta: typing.SupportsFloat, mask: viennals3d.viennals3d.Domain) -> None:
        ...
    @typing.overload
...
class DenseCellSet:
    ...
    def clear(self) -> None:
        ...
        """
    def fromLevelSets(self, levelSets: collections.abc.Sequence[viennals3d.viennals3d.Domain], materialMap: viennals3d.viennals3d.MaterialMap = None, depth: typing.SupportsFloat = 0.0) -> None:
        ...
...
class Domain:
    ...
    def __init__(self, domain: Domain) -> None:
        ...
        """
    @typing.overload
    def __init__(self, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, boundary: viennals3d.viennals3d.BoundaryConditionEnum = ...) -> None:
        ...
    @typing.overload
    def __init__(self, bounds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"], boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals3d.viennals3d.BoundaryConditionEnum], "FixedSize(3)"], gridDelta: typing.SupportsFloat = 1.0) -> None:
        ...
    @typing.overload
    ...
    def addMetaData(self, arg0: collections.abc.Mapping[str, collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
        """
    def applyBooleanOperation(self, arg0: viennals3d.viennals3d.Domain, arg1: ...) -> None:
        ...
    def clear(self) -> None:
        ...
    ...
    def generateCellSet(self, arg0: typing.SupportsFloat, arg1: Material, arg2: bool) -> None:
        ...
        """
    def getBoundaryConditions(self) -> typing.Annotated[list[viennals3d.viennals3d.BoundaryConditionEnum], "FixedSize(3)"]:
        """
    ...
    def getSetup(self) -> DomainSetup:
        ...
        """
    def insertNextLevelSet(self, levelset: viennals3d.viennals3d.Domain, wrapLowerLevelSet: bool = True) -> None:
        """
        Insert a level set to domain.
        """
    def insertNextLevelSetAsMaterial(self, levelSet: viennals3d.viennals3d.Domain, material: Material, wrapLowerLevelSet: bool = True) -> None:
        """
    ...
    def setup(self, arg0: DomainSetup) -> None:
        ...
        """
    @typing.overload
    def setup(self, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat = 0.0, boundary: viennals3d.viennals3d.BoundaryConditionEnum = ...) -> None:
        """
        Setup the domain.
        """
class DomainSetup:
    ...
    def __init__(self, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, boundary: viennals3d.viennals3d.BoundaryConditionEnum = ...) -> None:
        ...
    def boundaryCons(self) -> typing.Annotated[list[viennals3d.viennals3d.BoundaryConditionEnum], "FixedSize(3)"]:
        ...
...
class GDSGeometry:
    ...
    def __init__(self, gridDelta: typing.SupportsFloat) -> None:
        ...
    @typing.overload
    def __init__(self, gridDelta: typing.SupportsFloat, boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals3d.viennals3d.BoundaryConditionEnum], "FixedSize(3)"]) -> None:
        ...
    ...
    def getNumberOfStructures(self) -> int:
        ...
        """
    def layerToLevelSet(self, layer: typing.SupportsInt, baseHeight: typing.SupportsFloat = 0.0, height: typing.SupportsFloat = 1.0, mask: bool = False, blurLayer: bool = True) -> viennals3d.viennals3d.Domain:
        ...
    def print(self) -> None:
        """
        Print the geometry contents.
        """
    def setBoundaryConditions(self, arg0: collections.abc.Sequence[viennals3d.viennals3d.BoundaryConditionEnum]) -> None:
        """
...
class GeometryFactory:
    def __init__(self, domainSetup: DomainSetup, name: str = 'GeometryFactory') -> None:
        ...
    def makeBoxStencil(self, position: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], width: typing.SupportsFloat, height: typing.SupportsFloat, angle: typing.SupportsFloat = 0.0, length: typing.SupportsFloat = -1.0) -> viennals3d.viennals3d.Domain:
        ...
    def makeCylinderStencil(self, position: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], radius: typing.SupportsFloat, height: typing.SupportsFloat, angle: typing.SupportsFloat = 0.0) -> viennals3d.viennals3d.Domain:
        ...
    def makeMask(self, base: typing.SupportsFloat, height: typing.SupportsFloat) -> viennals3d.viennals3d.Domain:
        ...
    def makeSubstrate(self, base: typing.SupportsFloat) -> viennals3d.viennals3d.Domain:
        ...
...
class SphereDistribution(ProcessModel):
    @typing.overload
    def __init__(self, radius: typing.SupportsFloat, gridDelta: typing.SupportsFloat, mask: viennals3d.viennals3d.Domain) -> None:
        ...
    @typing.overload
