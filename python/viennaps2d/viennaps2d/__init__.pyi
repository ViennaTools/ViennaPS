...
from . import ray
from . import util
__all__: list[str] = ['AdvectionCallback', 'AdvectionParameters', 'AtomicLayerProcess', 'BoxDistribution', 'CF4O2Etching', 'CF4O2Parameters', 'CF4O2ParametersIons', 'CF4O2ParametersMask', 'CF4O2ParametersPassivation', 'CF4O2ParametersSi', 'CF4O2ParametersSiGe', 'CSVFileProcess', 'D', 'DenseCellSet', 'DirectionalProcess', 'Domain', 'Domain3D', 'DomainSetup', 'Extrude', 'FaradayCageEtching', 'FaradayCageParameters', 'FluorocarbonEtching', 'FluorocarbonParameters', 'FluorocarbonParametersIons', 'FluorocarbonParametersMask', 'FluorocarbonParametersPolymer', 'FluorocarbonParametersSi', 'FluorocarbonParametersSi3N4', 'FluorocarbonParametersSiO2', 'GDSGeometry', 'GDSReader', 'GeometryFactory', 'HBrO2Etching', 'HoleShape', 'IBEParameters', 'Interpolation', 'IonBeamEtching', 'IsotropicProcess', 'Length', 'LengthUnit', 'LogLevel', 'Logger', 'MakeFin', 'MakeHole', 'MakePlane', 'MakeStack', 'MakeTrench', 'Material', 'MaterialMap', 'MetaDataLevel', 'MultiParticleProcess', 'NormalizationType', 'OxideRegrowth', 'Planarize', 'PlasmaEtchingParameters', 'PlasmaEtchingParametersIons', 'PlasmaEtchingParametersMask', 'PlasmaEtchingParametersPassivation', 'PlasmaEtchingParametersPolymer', 'PlasmaEtchingParametersSubstrate', 'Process', 'ProcessModel', 'ProcessParams', 'RateGrid', 'RateSet', 'RayTracingParameters', 'Reader', 'SF6C4F8Etching', 'SF6O2Etching', 'SelectiveEpitaxy', 'SingleParticleALD', 'SingleParticleProcess', 'SphereDistribution', 'StencilLocalLaxFriedrichsScalar', 'TEOSDeposition', 'TEOSPECVD', 'Time', 'TimeUnit', 'ToDiskMesh', 'WetEtching', 'Writer', 'constants', 'ray', 'setNumThreads', 'util', 'version']
...
class AtomicLayerProcess:
    ...
    def setCoverageTimeStep(self, arg0: typing.SupportsFloat) -> None:
        ...
        """
    def setDesorptionRates(self, arg0: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        """
    ...
    def setDomain(self, arg0: Domain) -> None:
        ...
        """
    def setIntegrationScheme(self, arg0: viennals2d.viennals2d.IntegrationSchemeEnum) -> None:
        """
...
class BoxDistribution(ProcessModel):
    @typing.overload
    def __init__(self, halfAxes: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], gridDelta: typing.SupportsFloat, mask: viennals2d.viennals2d.Domain) -> None:
        ...
    @typing.overload
    def __init__(self, halfAxes: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], gridDelta: typing.SupportsFloat) -> None:
        ...
...
class DenseCellSet:
    ...
    def clear(self) -> None:
        ...
        """
    def fromLevelSets(self, levelSets: collections.abc.Sequence[viennals2d.viennals2d.Domain], materialMap: viennals2d.viennals2d.MaterialMap = None, depth: typing.SupportsFloat = 0.0) -> None:
        ...
    ...
    def getDepth(self) -> float:
        ...
        """
    def getElement(self, arg0: typing.SupportsInt) -> typing.Annotated[list[int], "FixedSize(4)"]:
        """
    ...
    def getElements(self) -> list[typing.Annotated[list[int], "FixedSize(4)"]]:
        ...
        """
    def getFillingFraction(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"]) -> float:
        """
    ...
    def getIndex(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"]) -> int:
        ...
        """
    def getNeighbors(self, arg0: typing.SupportsInt) -> typing.Annotated[list[int], "FixedSize(4)"]:
        """
...
class DirectionalProcess(ProcessModel):
    @typing.overload
    def __init__(self, direction: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], directionalVelocity: typing.SupportsFloat, isotropicVelocity: typing.SupportsFloat = 0.0, maskMaterial: Material = ..., calculateVisibility: bool = True) -> None:
        ...
    @typing.overload
    def __init__(self, direction: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], directionalVelocity: typing.SupportsFloat, isotropicVelocity: typing.SupportsFloat, maskMaterial: collections.abc.Sequence[Material], calculateVisibility: bool = True) -> None:
        ...
    @typing.overload
...
class Domain:
    ...
    def __init__(self, domain: Domain) -> None:
        ...
        """
    @typing.overload
    def __init__(self, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, boundary: viennals2d.viennals2d.BoundaryConditionEnum = ...) -> None:
        ...
    @typing.overload
    def __init__(self, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, boundary: viennals2d.viennals2d.BoundaryConditionEnum = ...) -> None:
        ...
    @typing.overload
    def __init__(self, bounds: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(4)"], boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals2d.viennals2d.BoundaryConditionEnum], "FixedSize(2)"], gridDelta: typing.SupportsFloat = 1.0) -> None:
        ...
    @typing.overload
    ...
    def addMetaData(self, arg0: collections.abc.Mapping[str, collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
        """
    def applyBooleanOperation(self, arg0: viennals2d.viennals2d.Domain, arg1: ...) -> None:
        ...
    def clear(self) -> None:
        ...
    ...
    def duplicateTopLevelSet(self, arg0: Material) -> None:
        ...
        """
    def generateCellSet(self, arg0: typing.SupportsFloat, arg1: Material, arg2: bool) -> None:
        """
        Generate the cell set.
        """
    def getBoundaryConditions(self) -> typing.Annotated[list[viennals2d.viennals2d.BoundaryConditionEnum], "FixedSize(2)"]:
        """
    ...
    def getSetup(self) -> DomainSetup:
        ...
        """
    def insertNextLevelSet(self, levelset: viennals2d.viennals2d.Domain, wrapLowerLevelSet: bool = True) -> None:
        """
        Insert a level set to domain.
        """
    def insertNextLevelSetAsMaterial(self, levelSet: viennals2d.viennals2d.Domain, material: Material, wrapLowerLevelSet: bool = True) -> None:
        """
    ...
    def setup(self, arg0: DomainSetup) -> None:
        ...
        """
    @typing.overload
    def setup(self, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat = 0.0, boundary: viennals2d.viennals2d.BoundaryConditionEnum = ...) -> None:
        """
        Setup the domain.
        """
class Domain3D:
    ...
    def deepCopy(self, arg0: Domain3D) -> None:
        ...
    def getBoundaryConditions(self) -> typing.Annotated[list[viennals2d.viennals2d.BoundaryConditionEnum], "FixedSize(3)"]:
        """
        Get the boundary conditions of the domain.
        """
    def getBoundingBox(self) -> typing.Annotated[list[typing.Annotated[list[float], "FixedSize(3)"]], "FixedSize(2)"]:
...
class DomainSetup:
    ...
    def __init__(self, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, boundary: viennals2d.viennals2d.BoundaryConditionEnum = ...) -> None:
        ...
    def boundaryCons(self) -> typing.Annotated[list[viennals2d.viennals2d.BoundaryConditionEnum], "FixedSize(2)"]:
        ...
...
class Extrude:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, inputDomain: Domain, outputDomain: Domain3D, extent: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"], extrudeDimension: typing.SupportsInt, boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals2d.viennals2d.BoundaryConditionEnum], "FixedSize(3)"]) -> None:
        ...
    def apply(self) -> None:
        """
        Run the extrusion.
        """
    def setBoundaryConditions(self, arg0: typing.Annotated[collections.abc.Sequence[viennals2d.viennals2d.BoundaryConditionEnum], "FixedSize(3)"]) -> None:
        """
...
class FaradayCageEtching(ProcessModel):
    ...
    def __init__(self, maskMaterials: collections.abc.Sequence[Material]) -> None:
        ...
    @typing.overload
    def __init__(self, maskMaterials: collections.abc.Sequence[Material], parameters: FaradayCageParameters) -> None:
        ...
...
class FluorocarbonEtching(ProcessModel):
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, ionFlux: typing.SupportsFloat, etchantFlux: typing.SupportsFloat, polyFlux: typing.SupportsFloat, meanIonEnergy: typing.SupportsFloat = 100.0, sigmaIonEnergy: typing.SupportsFloat = 10.0, ionExponent: typing.SupportsFloat = 100.0, deltaP: typing.SupportsFloat = 0.0, etchStopDepth: typing.SupportsFloat = -1.7976931348623157e+308) -> None:
        ...
    @typing.overload
...
class GDSGeometry:
    ...
    def __init__(self, gridDelta: typing.SupportsFloat) -> None:
        ...
    @typing.overload
    def __init__(self, gridDelta: typing.SupportsFloat, boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals2d.viennals2d.BoundaryConditionEnum], "FixedSize(2)"]) -> None:
        ...
    ...
    def getNumberOfStructures(self) -> int:
        ...
        """
    def layerToLevelSet(self, layer: typing.SupportsInt, blurLayer: bool = True) -> viennals2d.viennals2d.Domain:
        ...
    def print(self) -> None:
        """
        Print the geometry contents.
        """
    def setBoundaryConditions(self, arg0: collections.abc.Sequence[viennals2d.viennals2d.BoundaryConditionEnum]) -> None:
        """
...
class GeometryFactory:
    def __init__(self, domainSetup: DomainSetup, name: str = 'GeometryFactory') -> None:
        ...
    def makeBoxStencil(self, position: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"], width: typing.SupportsFloat, height: typing.SupportsFloat, angle: typing.SupportsFloat = 0.0, length: typing.SupportsFloat = -1.0) -> viennals2d.viennals2d.Domain:
        ...
    def makeCylinderStencil(self, position: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"], radius: typing.SupportsFloat, height: typing.SupportsFloat, angle: typing.SupportsFloat = 0.0) -> viennals2d.viennals2d.Domain:
        ...
    def makeMask(self, base: typing.SupportsFloat, height: typing.SupportsFloat) -> viennals2d.viennals2d.Domain:
        ...
    def makeSubstrate(self, base: typing.SupportsFloat) -> viennals2d.viennals2d.Domain:
        ...
...
class IonBeamEtching(ProcessModel):
    ...
    def __init__(self, maskMaterials: collections.abc.Sequence[Material]) -> None:
        ...
    @typing.overload
    def __init__(self, maskMaterials: collections.abc.Sequence[Material], parameters: IBEParameters) -> None:
        ...
...
class IsotropicProcess(ProcessModel):
    @typing.overload
    def __init__(self, rate: typing.SupportsFloat = 1.0, maskMaterial: Material = ...) -> None:
        ...
    @typing.overload
    def __init__(self, rate: typing.SupportsFloat, maskMaterial: collections.abc.Sequence[Material]) -> None:
        ...
    @typing.overload
    def __init__(self, materialRates: collections.abc.Mapping[Material, typing.SupportsFloat], defaultRate: typing.SupportsFloat = 0.0) -> None:
        ...
class Length:
    @staticmethod
...
class MakeFin:
    @typing.overload
    def __init__(self, domain: Domain, finWidth: typing.SupportsFloat, finHeight: typing.SupportsFloat, finTaperAngle: typing.SupportsFloat = 0.0, maskHeight: typing.SupportsFloat = 0, maskTaperAngle: typing.SupportsFloat = 0, halfFin: bool = False, material: Material = ..., maskMaterial: Material = ...) -> None:
        ...
    @typing.overload
    def __init__(self, domain: Domain, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, finWidth: typing.SupportsFloat, finHeight: typing.SupportsFloat, taperAngle: typing.SupportsFloat = 0.0, baseHeight: typing.SupportsFloat = 0.0, periodicBoundary: bool = False, makeMask: bool = False, material: Material = ...) -> None:
        ...
    def apply(self) -> None:
        """
...
class MakeHole:
    @typing.overload
    def __init__(self, domain: Domain, holeRadius: typing.SupportsFloat, holeDepth: typing.SupportsFloat, holeTaperAngle: typing.SupportsFloat = 0.0, maskHeight: typing.SupportsFloat = 0.0, maskTaperAngle: typing.SupportsFloat = 0.0, holeShape: HoleShape = ..., material: Material = ..., maskMaterial: Material = ...) -> None:
        ...
    @typing.overload
    def __init__(self, domain: Domain, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, holeRadius: typing.SupportsFloat, holeDepth: typing.SupportsFloat, taperingAngle: typing.SupportsFloat = 0.0, baseHeight: typing.SupportsFloat = 0.0, periodicBoundary: bool = False, makeMask: bool = False, material: Material = ..., holeShape: HoleShape = ...) -> None:
        ...
    def apply(self) -> None:
        """
...
class MakePlane:
    @typing.overload
    def __init__(self, domain: Domain, height: typing.SupportsFloat = 0.0, material: Material = ..., addToExisting: bool = False) -> None:
        ...
    @typing.overload
    def __init__(self, domain: Domain, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, height: typing.SupportsFloat = 0.0, periodicBoundary: bool = False, material: Material = ...) -> None:
        ...
    def apply(self) -> None:
        """
...
class MakeStack:
    @typing.overload
    def __init__(self, domain: Domain, numLayers: typing.SupportsInt, layerHeight: typing.SupportsFloat, substrateHeight: typing.SupportsFloat = 0, holeRadius: typing.SupportsFloat = 0, trenchWidth: typing.SupportsFloat = 0, maskHeight: typing.SupportsFloat = 0, taperAngle: typing.SupportsFloat = 0, halfStack: bool = False, maskMaterial: Material = ...) -> None:
        ...
    @typing.overload
...
class MakeTrench:
    @typing.overload
    def __init__(self, domain: Domain, trenchWidth: typing.SupportsFloat, trenchDepth: typing.SupportsFloat, trenchTaperAngle: typing.SupportsFloat = 0, maskHeight: typing.SupportsFloat = 0, maskTaperAngle: typing.SupportsFloat = 0, halfTrench: bool = False, material: Material = ..., maskMaterial: Material = ...) -> None:
        ...
    @typing.overload
    def __init__(self, domain: Domain, gridDelta: typing.SupportsFloat, xExtent: typing.SupportsFloat, yExtent: typing.SupportsFloat, trenchWidth: typing.SupportsFloat, trenchDepth: typing.SupportsFloat, taperingAngle: typing.SupportsFloat = 0.0, baseHeight: typing.SupportsFloat = 0.0, periodicBoundary: bool = False, makeMask: bool = False, material: Material = ...) -> None:
        ...
    def apply(self) -> None:
        """
...
class MultiParticleProcess(ProcessModel):
    ...
    def addNeutralParticle(self, stickingProbability: typing.SupportsFloat, label: str = 'neutralFlux') -> None:
        ...
    @typing.overload
    def addNeutralParticle(self, materialSticking: collections.abc.Mapping[Material, typing.SupportsFloat], defaultStickingProbability: typing.SupportsFloat = 1.0, label: str = 'neutralFlux') -> None:
        ...
    def setRateFunction(self, arg0: collections.abc.Callable[[collections.abc.Sequence[typing.SupportsFloat], Material], float]) -> None:
        ...
...
class Process:
    ...
    def __init__(self, domain: Domain) -> None:
        ...
    @typing.overload
    def __init__(self, domain: Domain, model: ProcessModel, duration: typing.SupportsFloat) -> None:
        ...
    def apply(self) -> None:
        """
        Run the process.
...
class SelectiveEpitaxy(ProcessModel):
    def __init__(self, materialRates: collections.abc.Sequence[tuple[Material, typing.SupportsFloat]], rate111: typing.SupportsFloat = 0.5, rate100: typing.SupportsFloat = 1.0) -> None:
        ...
class SingleParticleALD(ProcessModel):
    def __init__(self, stickingProbability: typing.SupportsFloat, numCycles: typing.SupportsFloat, growthPerCycle: typing.SupportsFloat, totalCycles: typing.SupportsFloat, coverageTimeStep: typing.SupportsFloat, evFlux: typing.SupportsFloat, inFlux: typing.SupportsFloat, s0: typing.SupportsFloat, gasMFP: typing.SupportsFloat) -> None:
        ...
class SingleParticleProcess(ProcessModel):
    @typing.overload
    def __init__(self, rate: typing.SupportsFloat = 1.0, stickingProbability: typing.SupportsFloat = 1.0, sourceExponent: typing.SupportsFloat = 1.0, maskMaterial: Material = ...) -> None:
        ...
    @typing.overload
    def __init__(self, rate: typing.SupportsFloat, stickingProbability: typing.SupportsFloat, sourceExponent: typing.SupportsFloat, maskMaterials: collections.abc.Sequence[Material]) -> None:
        ...
    @typing.overload
    def __init__(self, materialRates: collections.abc.Mapping[Material, typing.SupportsFloat], stickingProbability: typing.SupportsFloat, sourceExponent: typing.SupportsFloat) -> None:
        ...
class SphereDistribution(ProcessModel):
    @typing.overload
    def __init__(self, radius: typing.SupportsFloat, gridDelta: typing.SupportsFloat, mask: viennals2d.viennals2d.Domain) -> None:
        ...
    @typing.overload
    def __init__(self, radius: typing.SupportsFloat, gridDelta: typing.SupportsFloat) -> None:
        ...
