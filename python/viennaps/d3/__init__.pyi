...
class BoxDistribution(ProcessModel):
    @typing.overload
    def __init__(self, halfAxes: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], gridDelta: typing.SupportsFloat, mask: viennals.d3.Domain) -> None:
        ...
    @typing.overload
...
class Domain:
    ...
    def addMetaData(self, arg0: collections.abc.Mapping[str, collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
        """
    def applyBooleanOperation(self, arg0: viennals.d3.Domain, arg1: viennals._core.BooleanOperationEnum) -> None:
        ...
    def clear(self) -> None:
        ...
...
class SphereDistribution(ProcessModel):
    @typing.overload
    def __init__(self, radius: typing.SupportsFloat, gridDelta: typing.SupportsFloat, mask: viennals.d3.Domain) -> None:
        ...
    @typing.overload
