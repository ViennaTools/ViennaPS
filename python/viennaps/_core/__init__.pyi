...
class CF4O2Parameters:
    ...
    def gamma_C(
        ...
        arg0: collections.abc.Mapping[
            Material, typing.SupportsFloat | typing.SupportsIndex
        ],
    ) -> None: ...
    @property
...
class Extrude:
    ...
    def __init__(
        ...
        extrusionAxis: typing.SupportsInt | typing.SupportsIndex,
...
class MaterialMap:
    @staticmethod
    def isMaterial(
        arg0: typing.SupportsFloat | typing.SupportsIndex, arg1: Material
    ) -> bool: ...
    @staticmethod
    ...
    def __init__(self) -> None: ...
    def getMaterialAtIdx(
        self, arg0: typing.SupportsInt | typing.SupportsIndex
    ) -> Material: ...
    def getMaterialIdAtIdx(
        self, arg0: typing.SupportsInt | typing.SupportsIndex
    ) -> int: ...
...
class ProcessParams:
    ...
    def getScalarDataLabel(
        self, arg0: typing.SupportsInt | typing.SupportsIndex
    ) -> str: ...
    def insertNextScalar(
        self, arg0: typing.SupportsFloat | typing.SupportsIndex, arg1: str
    ) -> None: ...
...
class RateSet:
    ...
    def __init__(
        ...
        directionalVelocity: typing.SupportsFloat | typing.SupportsIndex = 0.0,
        isotropicVelocity: typing.SupportsFloat | typing.SupportsIndex = 0.0,
...
class Slice:
    ...
    def __init__(
        ...
        sliceDimension: typing.SupportsInt | typing.SupportsIndex,
        slicePosition: typing.SupportsFloat | typing.SupportsIndex,
    ) -> None: ...
    def apply(self) -> None:
        """
        Run the slicing.
