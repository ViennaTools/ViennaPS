...
class BoxDistribution(ProcessModel):
    @typing.overload
    def __init__(self, halfAxes: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"], gridDelta: typing.SupportsFloat, mask: viennals.d2.Domain) -> None:
        ...
    @typing.overload
...
class DenseCellSet:
    ...
    def clear(self) -> None:
        ...
        """
    def fromLevelSets(self, levelSets: collections.abc.Sequence[viennals.d2.Domain], materialMap: viennals._core.MaterialMap = None, depth: typing.SupportsFloat = 0.0) -> None:
        ...
...
class Domain:
    ...
    def addMetaData(self, arg0: collections.abc.Mapping[str, collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
        """
    def applyBooleanOperation(self, arg0: viennals.d2.Domain, arg1: viennals._core.BooleanOperationEnum) -> None:
        ...
    def clear(self) -> None:
        ...
    ...
    def getSetup(self) -> DomainSetup:
        ...
        """
    def insertNextLevelSet(self, levelset: viennals.d2.Domain, wrapLowerLevelSet: bool = True) -> None:
        """
...
class FaradayCageEtching(ProcessModel):
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, maskMaterials: collections.abc.Sequence[viennaps._core.Material]) -> None:
        ...
    @typing.overload
    def __init__(self, maskMaterials: collections.abc.Sequence[viennaps._core.Material], parameters: viennaps._core.FaradayCageParameters) -> None:
        ...
...
class GDSGeometry:
    ...
    def __init__(self, gridDelta: typing.SupportsFloat) -> None:
        ...
    @typing.overload
    def __init__(self, gridDelta: typing.SupportsFloat, boundaryConditions: typing.Annotated[collections.abc.Sequence[viennals._core.BoundaryConditionEnum], "FixedSize(2)"]) -> None:
        ...
    ...
    def getNumberOfStructures(self) -> int:
        ...
        """
    def layerToLevelSet(self, layer: typing.SupportsInt, blurLayer: bool = True) -> viennals.d2.Domain:
        ...
    def print(self) -> None:
        """
...
class GeometryFactory:
    def __init__(self, domainSetup: DomainSetup, name: str = 'GeometryFactory') -> None:
        ...
    def makeBoxStencil(self, position: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"], width: typing.SupportsFloat, height: typing.SupportsFloat, angle: typing.SupportsFloat = 0.0, length: typing.SupportsFloat = -1.0) -> viennals.d2.Domain:
        ...
    def makeCylinderStencil(self, position: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(2)"], radius: typing.SupportsFloat, height: typing.SupportsFloat, angle: typing.SupportsFloat = 0.0) -> viennals.d2.Domain:
        ...
    def makeMask(self, base: typing.SupportsFloat, height: typing.SupportsFloat) -> viennals.d2.Domain:
        ...
...
class IonBeamEtching(ProcessModel):
    ...
    def __init__(self, maskMaterials: collections.abc.Sequence[viennaps._core.Material]) -> None:
        ...
    @typing.overload
    def __init__(self, maskMaterials: collections.abc.Sequence[viennaps._core.Material], parameters: viennaps._core.IBEParameters) -> None:
        ...
...
class Process:
    ...
    def __init__(self, domain: Domain) -> None:
        ...
    @typing.overload
    def __init__(self, domain: Domain, model: ProcessModelBase, duration: typing.SupportsFloat) -> None:
        ...
    def apply(self) -> None:
        """
        Run the process.
    ...
    def setProcessModel(self, arg0: ProcessModelBase) -> None:
        ...
        """
    def setRayTracingParameters(self, arg0: viennaps._core.RayTracingParameters) -> None:
        """
...
class SphereDistribution(ProcessModel):
    @typing.overload
    def __init__(self, radius: typing.SupportsFloat, gridDelta: typing.SupportsFloat, mask: viennals.d2.Domain) -> None:
        ...
    @typing.overload
