...
import typing
__all__ = ['AdvectionCallback', 'Air', 'Al2O3', 'AnisotropicProcess', 'AtomicLayerProcess', 'BoxDistribution', 'Cu', 'D', 'DEBUG', 'DenseCellSet', 'Dielectric', 'DirectionalEtching', 'Domain', 'ERROR', 'FluorocarbonEtching', 'FluorocarbonParameters', 'FluorocarbonParametersIons', 'FluorocarbonParametersMask', 'FluorocarbonParametersPolymer', 'FluorocarbonParametersSi', 'FluorocarbonParametersSi3N4', 'FluorocarbonParametersSiO2', 'GAS', 'GDSGeometry', 'GDSReader', 'GaN', 'INFO', 'INTERMEDIATE', 'IsotropicProcess', 'LogLevel', 'Logger', 'MakeFin', 'MakeHole', 'MakePlane', 'MakeStack', 'MakeTrench', 'Mask', 'Material', 'MaterialMap', 'MeanFreePath', 'Metal', 'NEG_X', 'NEG_Y', 'NEG_Z', 'OxideRegrowth', 'POS_X', 'POS_Y', 'POS_Z', 'Particle', 'Planarize', 'PlasmaDamage', 'PolySi', 'Polymer', 'Precursor', 'Process', 'ProcessModel', 'ProcessParams', 'SF6O2Etching', 'SF6O2Parameters', 'SF6O2ParametersIons', 'SF6O2ParametersMask', 'SF6O2ParametersPassivation', 'SF6O2ParametersSi', 'SegmentCells', 'Si', 'Si3N4', 'SiC', 'SiGe', 'SiN', 'SiO2', 'SiON', 'SingleParticleProcess', 'SphereDistribution', 'TEOSDeposition', 'TIMING', 'TiN', 'Timer', 'ToDiskMesh', 'Undefined', 'W', 'WARNING', 'WriteVisualizationMesh', 'rayReflectionConedCosine', 'rayReflectionDiffuse', 'rayReflectionSpecular', 'rayTraceDirection', 'setNumThreads']
class AdvectionCallback:
    ...
    def domain(*args, **kwargs):
        """
        (self: viennaps3d._viennaps3d.AdvectionCallback, arg0: psDomain<double, 3>) -> None
        """
...
class DenseCellSet:
    ...
    def getAverageFillingFraction(self, arg0: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)], arg1: float) -> float:
        ...
        """
    def getBoundingBox(self) -> typing.Annotated[list[typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]], pybind11_stubgen.typing_ext.FixedSize(2)]:
        ...
    ...
    def getDepth(self) -> float:
        ...
        """
    def getElement(self, arg0: int) -> typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(8)]:
        """
        Get the element at the given index.
        """
    def getElements(self) -> list[typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(8)]]:
        """
        Get elements (cells). The indicies in the elements correspond to the corner nodes.
        """
    def getFillingFraction(self, arg0: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]) -> float:
        """
    ...
    def getIndex(self, arg0: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]) -> int:
        ...
        """
    def getNeighbors(self, arg0: int) -> typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(6)]:
        """
    ...
    def setFillingFraction(self, arg0: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)], arg1: float) -> bool:
        ...
        """
    def setPeriodicBoundary(self, arg0: typing.Annotated[list[bool], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        """
...
class GDSGeometry:
    ...
    def getBounds(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(6)]:
        ...
        """
    def layerToLevelSet(self, arg0: int, arg1: float, arg2: float, arg3: bool) -> ...:
        """
    ...
    def print(self) -> None:
        ...
        """
    def setBoundaryConditions(self, arg0: list[...]) -> None:
        """
